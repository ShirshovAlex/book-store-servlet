...
import by.bookstore.dao.StoreStorage;
import by.bookstore.dao.inmemory.InMemoryStoreStorage;

public class StoreServiceImpl implements StoreService {
    private final StoreStorage storeStorage = new InMemoryStoreStorage();
