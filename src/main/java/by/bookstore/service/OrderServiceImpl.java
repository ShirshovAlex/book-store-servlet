...
import by.bookstore.dao.OrderStorage;
import by.bookstore.dao.inmemory.InMemoryOrderStorage;
import by.bookstore.entity.*;

public class OrderServiceImpl implements OrderService {
    private final OrderStorage orderStorage = new InMemoryOrderStorage();
