...
@WebServlet(name = "UpdateUserPasswordServlet",urlPatterns = "/user/updatePass")
public class UpdateUserPasswordServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        getServletContext().getRequestDispatcher("/pages/user/updatePass.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        userService.updatePassword(pass, Integer.parseInt(id));
        resp.sendRedirect("/");
    }
}
