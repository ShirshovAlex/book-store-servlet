...
@WebServlet(urlPatterns = "/user/removeByUser")
public class RemoveUserByUserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        getServletContext().getRequestDispatcher("/pages/user/removeUserByName.jsp").forward(req, resp);
